...
public class RedeNeural implements Serializable
{
  ...
  public RedeNeural(int thresholdBleaching, int numeroEntradasRAMs, int tamanhoEntrada)
  {	
  ...
  public void train(List<Boolean> entrada) throws IOException
  {
  ...
  public int classify(List<Boolean> entrada) throws IOException
  {
    List<Boolean> entradaReorganizada = retina.organize(entrada);
    int saida = 0;
